export default function Home() {
	return (
		<div className=" container relative flex flex-col-reverse py-16 lg:pt-0 lg:flex-col lg:pb-0 ">
			...
			<div className="relative flex flex-col items-start w-full mx-auto md:px-0  ">
